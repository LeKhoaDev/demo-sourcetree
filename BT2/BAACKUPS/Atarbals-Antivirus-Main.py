...
#Import path
from all_paths import username_file_path,password_file_path,email_file_path,purchase_file_path, multi_scan_path, directory_scan_path
...
class Scan_Utility(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_13 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: multi_scan(self),
            relief="flat"
        )
        button_13.place(
            x=475.0,
