...
try:
    ...
    from tkinter import font as tkfont  # python 2
...
"""with open(multi_scan_path, 'r') as file:
    multi_scan = file.read().rstrip('\n')

with open(directory_scan_path, 'r') as file:
    directory_scan = file.read().rstrip('\n')"""

First_name = username.split(" ")[0]
Last_name = username.split(" ")[-1]
class ProtecTKers_Antivirus(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("ProtecTKers V1 Anti-Virus")
        #self.resizable(False, False)
...
class Scan(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button_7 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda *args: [f for f in [ make_something(1) , controller.show_frame("Scan_Utility")]],
            relief="flat"
        )
        button_7.place(
            x=640.0,
        ...
        button_10 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command= lambda *args: [f for f in [ make_something(0) , controller.show_frame("Scan_Utility")]] ,     
            relief="flat"
        )
        button_10.place(
            x=311.0,
...
class Home(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas.create_rectangle(
            ...
            fill="#FFFFFF",
            outline="")
        canvas.create_line(23, 40, 249, 40, fill="white", width=10)
        button_image_1 = PhotoImage(
            file=relative_to_assets("button_1.png"))
        button_1 = Button(
            canvas,
